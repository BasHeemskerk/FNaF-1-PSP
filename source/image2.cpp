        ...
        namespace office{
            ...
            */
            ...
            void loadCams(){
                ...
                if (freddyPosition == 0 && bonniePosition == 0 && chicaPosition == 0){
                    cams[0] = loadPng("romfs/gfx/office/camera/main/cam1a.png");
                }
                else if (freddyPosition == 0 && bonniePosition > 0 && chicaPosition == 0){
                    cams[0] = loadPng("romfs/gfx/office/camera/animatronic/cam1a/cam1a-freddy&chica.png");
                }
                else if (freddyPosition == 0 && bonniePosition == 0 && chicaPosition > 0){
                    cams[0] = loadPng("romfs/gfx/office/camera/animatronic/cam1a/cam1a-freddy&bonnie.png");
                }
                else if (freddyPosition == 0 && bonniePosition > 0 && chicaPosition > 0){
                    if (save::whichNight < 4){
                        cams[0] = loadPng("romfs/gfx/office/camera/animatronic/cam1a/cam1a-freddy.png");
                    }
                    else{
                        cams[0] = loadPng("romfs/gfx/office/camera/animatronic/cam1a/cam1a-freddystare.png");
                    }
                }
                else if (freddyPosition > 0 && bonniePosition > 0 && chicaPosition > 0){
                    cams[0] = loadPng("romfs/gfx/office/camera/animatronic/cam1a/cam1a-empty.png");
                }

                //im so sorry please forgive me for this terrible code, yes i am talking to you decompiler!
                if (bonniePosition != 1 && chicaPosition != 1 && bonniePosition != 2 && chicaPosition != 2 && freddyPosition != 1 ){
                    cams[1] = loadPng("romfs/gfx/office/camera/main/cam1b.png");
                }
                else if (bonniePosition == 1 && chicaPosition != 1 && freddyPosition != 1 && bonniePosition != 2 && chicaPosition != 2){
                    cams[1] = loadPng("romfs/gfx/office/camera/animatronic/cam1b/cam1b-bonnie.png");
                }
                else if (bonniePosition != 1 && chicaPosition == 1 && freddyPosition != 1 && bonniePosition != 2 && chicaPosition != 2){
                    cams[1] = loadPng("romfs/gfx/office/camera/animatronic/cam1b/cam1b-chica.png");
                }
                else if (bonniePosition == 1 && chicaPosition == 1 && freddyPosition != 1 && bonniePosition != 2 && chicaPosition != 2){
                    cams[1] = loadPng("romfs/gfx/office/camera/animatronic/cam1b/cam1b-bonnie.png");
                }
                    ...
                    cams[1] = loadPng("romfs/gfx/office/camera/animatronic/cam1b/cam1b-freddy.png");
                }
                else if (bonniePosition == 1 && chicaPosition != 1 && freddyPosition == 1 && bonniePosition != 2 && chicaPosition != 2){
                    cams[1] = loadPng("romfs/gfx/office/camera/animatronic/cam1b/cam1b-freddy.png");
                }
                    ...
                    cams[1] = loadPng("romfs/gfx/office/camera/animatronic/cam1b/cam1b-bonnieclose.png");
                }
                else if (bonniePosition != 1 && chicaPosition != 1 && freddyPosition != 1 && bonniePosition != 2 && chicaPosition == 2){
                    cams[1] = loadPng("romfs/gfx/office/camera/animatronic/cam1b/cam1b-chicaclose.png");
                }
                else if (bonniePosition != 1 && chicaPosition != 1 && freddyPosition != 1 && bonniePosition == 2 && chicaPosition == 2){
                    cams[1] = loadPng("romfs/gfx/office/camera/animatronic/cam1b/cam1b-bonnieclose.png");
                }
                ...
                if (foxyPosition == 0){
                    cams[2] = loadPng("romfs/gfx/office/camera/main/cam1c.png");
                }
                else if (foxyPosition == 1){
                    cams[2] = loadPng("romfs/gfx/office/camera/animatronic/cam1c/cam1c-foxy1.png");
                }
                else if (foxyPosition == 2){
                    cams[2] = loadPng("romfs/gfx/office/camera/animatronic/cam1c/cam1c-foxy2.png");
                }
                else if (foxyPosition >= 3){
                    cams[2] = loadPng("romfs/gfx/office/camera/animatronic/cam1c/cam1c-foxy3.png");
                }

                if (bonniePosition != 3){
                    cams[3] = loadPng("romfs/gfx/office/camera/main/cam2a.png");
                }
                else if (bonniePosition == 3){
                    cams[3] = loadPng("romfs/gfx/office/camera/animatronic/cam2a/cam2a-bonnie.png");
                }

                if (bonniePosition != 5){
                    cams[4] = loadPng("romfs/gfx/office/camera/main/cam2b.png");
                }
                else if (bonniePosition == 5){
                    cams[4] = loadPng("romfs/gfx/office/camera/animatronic/cam2b/cam2b-bonnie.png");
                }

                if (bonniePosition != 4){
                    cams[5] = loadPng("romfs/gfx/office/camera/main/cam3.png");
                }
                else if (bonniePosition == 4){
                    cams[5] = loadPng("romfs/gfx/office/camera/animatronic/cam3/cam3-bonnie.png");
                }

                if (chicaPosition != 3 && chicaPosition != 4 && freddyPosition != 3){
                    cams[6] = loadPng("romfs/gfx/office/camera/main/cam4a.png");
                }
                else if (chicaPosition == 3 && freddyPosition != 3){
                    cams[6] = loadPng("romfs/gfx/office/camera/animatronic/cam4a/cam4a-chica.png");
                }
                else if (chicaPosition == 4 && freddyPosition != 3){
                    cams[6] = loadPng("romfs/gfx/office/camera/animatronic/cam4a/cam4a-chicaclose.png");
                }
                else if (chicaPosition != 3 && chicaPosition != 4 && freddyPosition == 3){
                    cams[6] = loadPng("romfs/gfx/office/camera/animatronic/cam4a/cam4a-freddy.png");
                }
                else if (chicaPosition == 3 && chicaPosition != 4 && freddyPosition == 3){
                    cams[6] = loadPng("romfs/gfx/office/camera/animatronic/cam4a/cam4a-freddy.png");
                }
                ...
                if (chicaPosition != 5 && freddyPosition != 4){
                    cams[7] = loadPng("romfs/gfx/office/camera/main/cam4b.png");
                }
                else if (chicaPosition == 5 && freddyPosition != 4){
                    cams[7] = loadPng("romfs/gfx/office/camera/animatronic/cam4b/cam4b-chica.png");
                }
                else if (chicaPosition != 5 && freddyPosition == 4){
                    cams[7] = loadPng("romfs/gfx/office/camera/animatronic/cam4b/cam4b-freddy.png");
                }
                else if (chicaPosition == 5 && freddyPosition == 4){
                    cams[7] = loadPng("romfs/gfx/office/camera/animatronic/cam4b/cam4b-freddy.png");
                }
                ...
                if (bonniePosition != 7){
                    cams[8] = loadPng("romfs/gfx/office/camera/main/cam5.png");
                }
                else if (bonniePosition == 7){
                    if (save::whichNight > 4){
                        cams[8] = loadPng("romfs/gfx/office/camera/animatronic/cam5/cam5-bonnieclose.png");
                    }
                    else{
                        cams[8] = loadPng("romfs/gfx/office/camera/animatronic/cam5/cam5-bonnie.png");
                    }
                }

                cams[9] = loadPng("romfs/gfx/office/camera/main/cam6.png");

                if (chicaPosition != 7 && chicaPosition != 8 && freddyPosition != 2){
                    cams[10] = loadPng("romfs/gfx/office/camera/main/cam7.png");
                }
                else if (chicaPosition == 7 && chicaPosition != 8 && freddyPosition != 2){
                    cams[10] = loadPng("romfs/gfx/office/camera/animatronic/cam7/cam7-chica.png");
                }
                else if (chicaPosition != 7 && chicaPosition == 8 && freddyPosition != 2){
                    cams[10] = loadPng("romfs/gfx/office/camera/animatronic/cam7/cam7-chicaclose.png");
                }
                else if (chicaPosition != 7 && chicaPosition != 8 && freddyPosition == 2){
                    cams[10] = loadPng("romfs/gfx/office/camera/animatronic/cam7/cam7-freddy.png");
                }
                else if (chicaPosition == 7 && chicaPosition != 8 && freddyPosition == 2){
                    cams[10] = loadPng("romfs/gfx/office/camera/animatronic/cam7/cam7-freddy.png");
                }
